**Porównanie metod rozwiązywania układów równań liniowych**

Projekt implementuje i porównuje trzy metody rozwiązywania równań liniowych:  
-**Jacobiego** - metoda iteracyjna  
-**Gaussa-Seidela** - metoda iteracyjna  
-**LU** - metoda bezpośrednia  
